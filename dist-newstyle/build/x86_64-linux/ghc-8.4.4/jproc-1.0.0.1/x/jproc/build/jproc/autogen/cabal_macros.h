...
/* package jproc-1.0.0.1 */
#ifndef VERSION_jproc
#define VERSION_jproc "1.0.0.1"
#endif /* VERSION_jproc */
#ifndef MIN_VERSION_jproc
#define MIN_VERSION_jproc(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_jproc */
...
#define CURRENT_COMPONENT_ID "jproc-1.0.0.1-inplace-jproc"
