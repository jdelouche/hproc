...
/* package hproc-1.0.0.1 */
#ifndef VERSION_hproc
#define VERSION_hproc "1.0.0.1"
#endif /* VERSION_hproc */
#ifndef MIN_VERSION_hproc
#define MIN_VERSION_hproc(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_hproc */
...
#define CURRENT_COMPONENT_ID "hproc-1.0.0.1-inplace-hproc"
